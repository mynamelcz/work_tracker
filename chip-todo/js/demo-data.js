    ...
    const demoData = {
      ...
      data: {
        ...
        tasks: [
          ...
          { id: 't_303', projectId: 'p_201', name: '低温启动边界测试', description: '验证 -20C 冷启动稳定性与首次上电时序。', assignee: 'm_101', status: 'pending', priority: 'medium', progress: 0, weekKey: '2026-W10', createdAt: '2026-03-03T09:40:00.000Z', completedAt: null },
          ...
          { id: 't_307', projectId: 'p_202', name: '动态电压切换脚本补齐', description: '增加 ATE 动态压降场景，补充异常日志导出。', assignee: 'm_105', status: 'pending', priority: 'medium', progress: 0, weekKey: '2026-W10', createdAt: '2026-03-03T11:00:00.000Z', completedAt: null },
          ...
          { id: 't_314', projectId: 'p_205', name: '导入覆盖提示优化', description: '导入前显示覆盖范围与备份建议。', assignee: 'm_101', status: 'pending', priority: 'medium', progress: 0, weekKey: '2026-W10', createdAt: '2026-03-03T14:20:00.000Z', completedAt: null },
